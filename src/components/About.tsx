  ...
  return (
    <section id="about" className="py-24 px-4 sm:px-6 relative">
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse 60% 40% at 80% 50%, rgba(255,107,0,0.05) 0%, transparent 70%)' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-display font-extrabold text-4xl sm:text-5xl text-white mb-6 leading-tight">
              Where Ideas<br />
              <span className="text-gradient-ember">Catch Fire</span>
            </h2>
            <div className="space-y-4 text-gray-400 font-body leading-relaxed">
              ...
              <p>
                Only <strong className="text-ember-400">20 teams</strong> get in. Every slot counts. Every idea matters.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-10">
              {STATS.map((stat, i) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-4 h-4 text-ember-500 mx-auto mb-2" />
          ...
          >
            <span className="font-mono text-xs text-ember-400 uppercase tracking-widest mb-6 block">
              // Event Timeline
            </span>
                  ...
                  >
                    ...
                    <div className="relative z-10 w-12 h-12 flex-shrink-0 rounded-full flex items-center justify-center"
                      ...
                      <motion.div
                        ...
                        className="w-3 h-3 rounded-full bg-ember-500"
                      />
                    </div>
                    {/* Content */}
                    <div className="pt-2">
                      <p className="font-mono text-xs text-ember-400 mb-1 uppercase tracking-wider">{item.date}</p>
