    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-16">
      ...
      >
        ...
        <motion.div variants={childVariants} className="flex justify-center">
          <div className="relative">
            ...
            <motion.div
              ...
              style={{ background: 'radial-gradient(circle, rgba(255,107,26,0.3) 0%, transparent 70%)' }}
            />
            <div
        ...
        <motion.div variants={childVariants}>
          <h1 className="font-display font-extrabold text-4xl text-galaksi-100 mb-2">
            You're registered
          </h1>
          <p className="text-stone-400">
            Team <strong className="text-galaksi-100">"{teamName}"</strong> is registered for igniteX.
            <br />
            <span className="text-sm text-stone-300">Your spot is confirmed once we verify your payment.</span>
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3">
            <span className="font-mono font-bold text-3xl text-galaksi-100 tracking-widest">
              {registrationId}
            </span>
            <button onClick={copyId} aria-label="Copy registration ID" className="w-11 h-11 flex items-center justify-center rounded-lg hover:bg-white/5 active:bg-white/10 transition-colors">
              <FiCopy className="w-4 h-4 text-stone-400 hover:text-galaksi-400 transition-colors" />
            </button>
          </div>
        ...
        <motion.div variants={childVariants} className="space-y-3">
          ...
          >
            ...
            <div>
              <p className="font-display font-semibold text-galaksi-100 text-sm">Event Dates</p>
              <p className="text-stone-400 text-xs">28th & 29th September · 9:30 AM onwards</p>
            </div>
          </div>
          <p className="text-xs text-stone-500">
            Your ticket is emailed to the team once the payment is verified.
          </p>
        </motion.div>
          ...
          <svg width="200" height="2" viewBox="0 0 200 2" className="mx-auto">
            ...
            <defs>
              <linearGradient id="confGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <stop offset="50%" stopColor="#FF9A5C" stopOpacity="1" />
                <stop offset="100%" stopColor="#E2560D" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        </motion.div>
